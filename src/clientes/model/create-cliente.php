<?php
    ...
    if (!$conn) {
        ...
        if ( empty($requestData['nome']) || empty($requestData['ativo']) || empty($requestData['email'])) {
            ...
            $sql = "INSERT INTO clientes VALUES (null, '$requestData[nome]', '$requestData[email]', '$requestData[telefone]', '$requestData[ativo]', '$requestData[dataagora]', '$requestData[dataagora]')";
